...
export default function Header() {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        const response = await fetch("https://service.pace-unv.cloud/api/user/me", {
          headers: {
          ...
          <div className="flex flex-wrap justify-between items-center">
            <div className="flex justify-start items-center">
              ...
              <a href="https://flowbite.com" className="flex items-center justify-between mr-4">
                ...
                {/* bagian 1 -----------------------------------------------------------------------------------------------------> */}
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">wezhare</span>
              </a>
            ...
            <div className="flex items-center lg:order-2">
              <button type="button" data-drawer-toggle="drawer-navigation" aria-controls="drawer-navigation" className="p-2 mr-1 text-gray-500 rounded-lg md:hidden hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
              ...
              {/* Dropdown menu */}
              <div className="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600 rounded-xl" id="apps-dropdown">
                <div className="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-600 dark:text-gray-300">
                  Apps
                </div>
                <div className="grid grid-cols-3 gap-4 p-4">
                  ...
                  <a href="#" className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                    ...
                    <div className="text-sm text-gray-900 dark:text-white" onClick={() => router.push('/register')} colorScheme="teal" m={2}>
                      Logout
                    </div>
                  </a>
                </div>
