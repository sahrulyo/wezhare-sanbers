                            ...
                            {users.map((user) => (
                                <Link href={`/users/${user.id}`} key={user.id}>
                                    <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                                        <a href="#">
                                            <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={user.image} alt={`${user.firstName} ${user.lastName}`} />
                                        </a>
                                        <div className="p-5">
                                            ...
                                            <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">{user.address.address}</p>
