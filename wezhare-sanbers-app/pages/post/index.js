...
const Post = () => {
  ...
  // const { data: listNotes, setData, deleteItem } = useQueries({ prefixUrl: "https://service.pace-unv.cloud/api/post/delete/1" });
  ...
  // };
    ...
    return (
        <div>
<section className="bg-white dark:bg-gray-900 mt-10 py-8 lg:py-16 antialiased">
<div className="max-w-4xl mx-auto px-4 pl-5">
    ...
    <footer className="flex justify-between items-center mb-2">
      ...
      <div id="dropdownComment1" className="hidden z-10 w-36 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
        <ul className="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconHorizontalButton">
          ...
          <li>
            <a href="#" className="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" onClick={() => handleDelete(item?.id)}>Remove</a>
          </li>
          <li>
